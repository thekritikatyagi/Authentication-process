...
class SignInTab extends StatefulWidget {
  ...
  const SignInTab({Key? key, required this.updateIndex}) : super(key: key);
...
class _SignInTabState extends State<SignInTab> {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
          ...
          child: const Text('Please login with your phone number',
              style: TextStyle(
  ...
  //handle sign in procedure
  _handleSignIn() async {
    //specific signin codes can be done inside this fun
